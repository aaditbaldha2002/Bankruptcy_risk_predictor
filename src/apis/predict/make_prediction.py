...
import boto3
from src.apis.predict.utils import api_cluster_predict_data, api_predict_on_cluster_label, inference_api_preprocess_data
import logging
...
def make_prediction(payload:BankruptcyPredictionInput):
    try:
        ...
        logging.error(f"Error in the make_prediction function:{e}")
        raise e